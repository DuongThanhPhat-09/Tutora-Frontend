...
const StudentLessons = () => {
    ...
    return (
        <div className={`${s.page} ${s.comingSoonPage}`}>
            {/* Coming Soon Overlay */}
            <div className={s.comingSoonOverlay}>
                <div className={s.comingSoonCard}>
                    <div className={s.comingSoonIcon}>🚀</div>
                    <h2 className={s.comingSoonTitle}>Chức năng đang được phát triển</h2>
                    <p className={s.comingSoonDesc}>
                        Tính năng quản lý buổi học đang được hoàn thiện và sẽ sớm được cập nhật.
                        Cảm ơn bạn đã kiên nhẫn chờ đợi!
                    </p>
                    <div className={s.comingSoonBadge}>
                        <span className={s.comingSoonDot}></span>
                        Đang phát triển
                    </div>
                </div>
            </div>
